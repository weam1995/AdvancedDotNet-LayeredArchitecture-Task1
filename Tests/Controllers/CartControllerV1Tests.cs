...
namespace CartServiceApp.Tests.Controllers
{
    public class CartControllerV1Tests
    {
        ...
        private readonly CartsControllerV1 _cartsController;
        public CartControllerV1Tests()
        {
            _cartService = new Mock<ICartService>();
            _cartsController = new CartsControllerV1(_cartService.Object);
        }
        ...
        [
            new CartItem
            {
                Id = 1,
                Name = "Product A",
                Price = new Money(19.99M, CatalogService.Domain.Enums.CurrencyCode.EUR),
                Quantity = 2
            },
            new CartItem
            {
                ...
                Price = new Money(29.99M, CatalogService.Domain.Enums.CurrencyCode.USD),
                Quantity = 1
            },
            new CartItem
            {
                Id = 3,
                Name = "Product C",
                Price = new Money(9.99M, CatalogService.Domain.Enums.CurrencyCode.USD),
                Quantity = 3
            }
        ];
        }
